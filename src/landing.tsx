  ...
  return (
    <div className="font-sans bg-gradient-to-br from-blue-50 to-indigo-100 text-gray-900 min-h-screen">
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              <i className="bi bi-truck text-3xl text-indigo-600"></i>
              <div>
                <div className="text-indigo-600 font-bold text-2xl">SAFARIS ADVENTURE</div>
                <div className="text-sm text-gray-600">Road Services Anywhere, Anytime</div>
              </div>
            </div>
            ...
            <div className="flex space-x-3">
              <a href="https://wa.me/254702308649" target="_blank" className="bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-medium transition-colors flex items-center space-x-2">
          ...
          {isMenuOpen && (
            <div className="md:hidden mt-4 pb-4 border-t border-gray-200 pt-4">
              ...
              <div className="mt-4 space-y-2">
                <a href="https://wa.me/254702308649" target="_blank" className="block bg-green-500 hover:bg-green-600 text-white px-4 py-2 rounded-lg font-medium text-center flex items-center justify-center space-x-2">
                  <i className="bi bi-whatsapp"></i>
                  <span>WhatsApp</span>
                </a>
                <button className="block w-full bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-medium">
                  Book Now
                </button>
              </div>
            </div>
          ...
          <div className="max-w-4xl text-white">
            ...
            <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6">
              <button 
                ...
                className="bg-indigo-600 hover:bg-indigo-700 text-white px-8 py-4 rounded-lg font-medium text-lg transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
              >
                Explore Services
              </button>
              <a
                ...
                target="_blank"
                className="border-2 border-white hover:bg-white hover:text-indigo-900 text-white px-8 py-4 rounded-lg font-medium text-lg transition-all text-center flex items-center justify-center space-x-2"
              >
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
            {services.map(service => (
              <div key={service.id} className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 group hover:-translate-y-2">
                {/* Image Carousel */}
                    ...
                    {service.images.length > 1 && (
                      <>
                        <button
                          ...
                          className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full w-8 h-8 flex items-center justify-center transition-all opacity-0 group-hover:opacity-100"
                        >
                          <i className="bi bi-chevron-left text-sm"></i>
                        </button>
                        <button
                          onClick={() => nextImage(service.id, service.images.length)}
                          className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-black/50 hover:bg-black/70 text-white rounded-full w-8 h-8 flex items-center justify-center transition-all opacity-0 group-hover:opacity-100"
                        >
                ...
                <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center mb-4 group-hover:bg-indigo-200 transition-colors duration-300">
                  <i className={`bi bi-${service.icon} text-2xl text-indigo-600 group-hover:scale-110 transition-transform duration-300`}></i>
                </div>
                <h3 className="text-xl font-bold mb-3 text-gray-900">{service.title}</h3>
                <p className="text-gray-600 mb-6 leading-relaxed">{service.description}</p>
                <button 
                  onClick={() => handleBooking(service)}
                  className="w-full bg-indigo-600 hover:bg-indigo-700 text-white py-3 px-4 rounded-lg font-medium transition-all duration-300 transform hover:scale-105 cursor-pointer"
                >
                  Book Now
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="p-8">
              <div className="flex justify-between items-center mb-6">
                <h3 className="text-2xl font-bold text-gray-900">Book {selectedService}</h3>
                <button 
                  onClick={closeModal}
                  className="text-gray-500 hover:text-gray-700 text-2xl cursor-pointer hover:bg-gray-100 rounded-full w-8 h-8 flex items-center justify-center transition-all"
                >
                  ×
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 pt-4">
                  <button 
                    ...
                    className="flex-1 bg-green-500 hover:bg-green-600 disabled:bg-gray-300 text-white py-3 px-6 rounded-lg font-medium transition-colors flex items-center justify-center space-x-2"
                  >
                    <i className="bi bi-whatsapp text-xl"></i>
      ...
      <section id="about" className="py-20 bg-gradient-to-br from-indigo-50 to-purple-50">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 text-gray-900">Why Choose Safaris Adventure</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                <i className="bi bi-bullseye text-3xl text-white"></i>
              </div>
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Customer Priority</h3>
              <p className="text-gray-600 leading-relaxed">Your comfort and demands are our top priority. We tailor our services to exceed your expectations every time.</p>
            </div>
            ...
            <div className="text-center group">
              <div className="w-20 h-20 bg-gradient-to-r from-green-500 to-teal-600 rounded-full flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                <i className="bi bi-person-check-fill text-3xl text-white"></i>
              </div>
              <h3 className="text-2xl font-bold mb-4 text-gray-900">Professional Drivers</h3>
              <p className="text-gray-600 leading-relaxed">Our experienced and courteous drivers ensure safe, reliable, and comfortable transportation for all occasions.</p>
            </div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map(testimonial => (
              <div key={testimonial.id} className="bg-gradient-to-br from-gray-50 to-white p-8 rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
        ...
        <div className="container mx-auto px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-6">
            <a
              href="https://wa.me/254702308649"
              target="_blank"
              className="bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-medium text-lg transition-all transform hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center justify-center space-x-2"
            >
              <i className="bi bi-whatsapp text-xl"></i>
              <span>WhatsApp: 0702308649</span>
            </a>
            <a
              href="tel:+254780253855"
              className="bg-blue-500 hover:bg-blue-600 text-white px-8 py-4 rounded-lg font-medium text-lg transition-all transform hover:scale-105 shadow-lg hover:shadow-xl inline-flex items-center justify-center space-x-2"
            >
              <i className="bi bi-telephone-fill text-xl"></i>
              <span>Call: 0780253855</span>
            </a>
          </div>
        </div>
      </section>
      ...
      <footer className="bg-gray-900 text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              <div className="flex items-center space-x-3 mb-6">
                <i className="bi bi-truck text-3xl text-indigo-400"></i>
                <div>
                  <h3 className="text-2xl font-bold text-indigo-400">SAFARIS ADVENTURES</h3>
                  <p className="text-gray-400">Road Services Anywhere, Anytime</p>
                </div>
              </div>
            ...
            <div>
              <h4 className="text-lg font-bold mb-6 text-indigo-400">Quick Links</h4>
            ...
            <div>
              <h4 className="text-lg font-bold mb-6 text-indigo-400">Contact Info</h4>
              <ul className="space-y-4">
                <li className="flex items-start space-x-3">
                  <i className="bi bi-telephone-fill text-indigo-400 mt-1"></i>
                ...
                <li className="flex items-start space-x-3">
                  <i className="bi bi-envelope-fill text-indigo-400 mt-1"></i>
                  <span className="text-gray-400">safarisadventure03@gmail.com</span>
                </li>
                <li className="flex items-start space-x-3">
                  <i className="bi bi-whatsapp text-indigo-400 mt-1"></i>
                  <span className="text-gray-400">WhatsApp Available 24/7</span>
                </li>
                <li className="flex items-start space-x-3">
                  <i className="bi bi-geo-alt-fill text-indigo-400 mt-1"></i>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-400">
            <p>&copy; {new Date().getFullYear()} Safaris Adventure. All rights reserved. | Designed by Xelerated Tech</p>
          </div>
        </div>
      </footer>
    </div>
